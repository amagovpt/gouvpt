...
class RequestedAttributeType_(SamlBase):
    """The http://autenticacao.cartaodecidadao.pt/atributos:RequestedAttributeType element """
...
class RequestedAttribute(RequestedAttributeType_):
    """The http://autenticacao.cartaodecidadao.pt/atributos:RequestedAttribute element """
...
class RequestedAttributesType_(SamlBase):
    """The http://autenticacao.cartaodecidadao.pt/atributos:RequestedAttributesType element """
    ...
    c_child_order = SamlBase.c_child_order[:]
    c_cardinality = SamlBase.c_cardinality.copy()
    c_children['{http://autenticacao.cartaodecidadao.pt/atributos}RequestedAttribute'] = ('requested_attribute', [RequestedAttribute])
...
class RequestedAttributes(RequestedAttributesType_):
    """The http://autenticacao.cartaodecidadao.pt/atributos:RequestedAttributes element """
